...
Code obtained from http://www.perlmonks.org/?node_id=780250
Also see: http://www.perlmonks.org/?node_id=482919

Authors: tim (http://www.perlmonks.org/?node_id=439528) 
         BioLion (http://www.perlmonks.org/?node_id=656648)
...
x = min(a+b, a+c) - "the right side".  (If you want "the left side", i
+.e. the sum of H(x; a+b, c+d, a+c) for x
